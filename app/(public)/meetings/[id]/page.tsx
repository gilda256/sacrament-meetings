...
export default async function MeetingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const meeting = await getMeetingById(parseInt(id));
    ...
    <main className="p-8 max-w-3xl mx-auto">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p>Hymn: {meeting.openingHymn ? `#${meeting.openingHymn.number} - ${meeting.openingHymn.title}` : 'N/A'}</p>
        ...
        <section>
          ...
          <p>{meeting.sacramentHymn ? `#${meeting.sacramentHymn.number} - ${meeting.sacramentHymn.title}` : 'N/A'}</p>
        </section>
        ...
        <section>
          ...
          <p>Hymn: {meeting.closingHymn ? `#${meeting.closingHymn.number} - ${meeting.closingHymn.title}` : 'N/A'}</p>
